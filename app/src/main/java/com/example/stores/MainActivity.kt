...
class MainActivity : AppCompatActivity(),OnClickListener,MainAux {
    ...
    * */
    ...
    private fun confirmDelete(storeEntity: StoreEntity){
        // Los set Button siempre piden un estrin y una accion en caso de qu se quiera serrar se pone null
        MaterialAlertDialogBuilder(this)
    ...
    private fun dial(phone :String){
        ...
        //si hay algo que pueda abrirlo
        //Si hay alguna actividad que resulva este tipo de intent
